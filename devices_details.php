...
<?php if (!isset($_SESSION['login']))
     ...
     if (isset($_SESSION['login']))
      ...
      echo"<li class='nav-item submenu dropdown active'>
            ...
            aria-haspopup='true' aria-expanded='false'> Hackstore </a>
           <ul class='dropdown-menu'>      
            <li class='nav-item'><a class='nav-link' href='devices.php'> Συσκευέςs </a></li>
...
$sql="SELECT device_name, device_title, device_mini_description, device_full_description, device_category, device_paypal_id  FROM devices_details where id = '$id' ";
    ...
    while ($row = $result->fetch_assoc())
      ...
      $device_category = $row['device_category'];
        ...
        if ($device_category == 'Internet Hacking')
          {
            $device_logo =  "<img src='img/slider/internet_hacking/internet_hacking1.png' height='450' width='80%'>";  
          }
     
     
      if ($device_category == 'GSM Hacking')
          {
          $device_logo =  "<img src='img/slider/gsm_hacking/gsm_hacking1.png' height='450' width='80%'>";  
          }
     
     
      if ($device_category == 'Full Hacking')
          {
        $device_logo =  "<img src='img/slider/full_hacking/0.png' height='450' width='80%'>";  
          }
          


     // $device_logo =  '<img src="data:image/jpeg;base64,'. base64_encode($row['device_logo']) .'" height=450 width=80% />';

      $device_title = $row['device_title'];
      
      $device_mini_description = $row['device_mini_description'];
      
      $device_full_description = $row['device_full_description'];
      
      
      $device_name = $row['device_name'];
      

	  $device_paypal_id = $row['device_paypal_id'];
		...
		echo	'<div class="row">
					...
					<div class="offset-md-1 col-md-5">
						<div class="portfolio_right_text mt-30">
							<h4> '.$device_title.' </h4>
							<p> '.$device_mini_description.' </p>
							<ul class="list">
								<li> 
								<li><span> Όν. συσκευής </span>: '.$device_name.' </li>
								<li><span> Κατηγορία </span>:  '.$device_category.' </li>
								...
								<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                                   ...
                                   <input type="hidden" name="hosted_button_id" value="'.$device_paypal_id.'">
        ...
        if ($device_category == 'Internet Hacking')
          {
            include'slider_internet_hacking.php';  
          }
     
     
      if ($device_category == 'GSM Hacking')
          {
            include'slider_gsm_hacking.php';  
          }
     
     
      if ($device_category == 'Full Hacking')
          {
            include'slider_full_hacking.php';  
          }
